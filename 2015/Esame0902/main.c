...
int ritorno;
char linea[256];
char opzione[10]; // contiene l'opzione per il comando head
...
printf("il figlio di indice %d ha trovato la linea %s \ndi numero %d nel file %s \n",i,linea,X,argv[2*i + 1]);
